...
using HomeSimulation3.Areas.Admin.ViewModels.Employee;
using HomeSimulation3.DAL;
using HomeSimulation3.Models;
using HomeSimulation3.Utilities.Image;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;

namespace HomeSimulation3.Areas.Admin.Controllers
{
    [Area("Admin")]
    ...
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> Update(UpdateEmployeeVM updateVM)
        {
            ...
            employee.FullAdress = updateVM.FullAdress;
